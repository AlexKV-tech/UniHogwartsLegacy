...
public abstract class Spell {
	...
	public Spell(String name, int manaCost, MagicLevel levelNeeded) {
		...
		if (manaCost < 0) throw new IllegalArgumentException("Mana cost is not allowed to be negative");
		if (levelNeeded == null) throw new IllegalArgumentException("Level needed is not allowed to be null");
		this.name = name;
	...
	public void cast(MagicSource source, MagicEffectRealization target) {
		if (source == null || target == null) throw new IllegalArgumentException("Null object was provided");
